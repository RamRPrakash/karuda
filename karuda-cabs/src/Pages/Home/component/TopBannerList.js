        ...
        return (
            <div >
                ...
                <div style={{display : 'flex' , marginTop : '3%'}}>
                    ...
                    <ReactWhatsapp number="9384841107" message="Chat with karuda cabs!!!" style={{ backgroundColor: '#cc0021', width: '330px', borderRadius: '10px', borderColor: '#cc0021' , marginLeft : '5%'}} >
